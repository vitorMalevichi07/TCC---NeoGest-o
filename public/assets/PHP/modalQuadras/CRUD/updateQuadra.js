document.getElementById('modalEditar').addEventListener('show.bs.modal', function (event) {
    ...
    fetch('./modalQuadras/CRUD/buscaDadosQuadra.php?id=' + quadraId)
        ...
        .then(data => {
            ...
            document.getElementById('descr_quadra_edit').value = data.descr || '';
            document.getElementById('disp_quadra_edit').value = data.disponibilidade;
            document.getElementById('mod_quadra_edit').value = data.modalidade || '';
            document.getElementById('valor_quadra_edit').value = data.valor_hora || '';
        });
});